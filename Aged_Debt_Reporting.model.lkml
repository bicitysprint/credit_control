...
##}
  ...
  join: vw_ageddebt_salecode_desc {
    ...
    relationship: one_to_one
    sql_on: ${vw_ageddebt_new_30032021.customer_key} = ${vw_ageddebt_salecode_desc.cust_key}  ;;
  }
...
##           }
               ...
               sql_on: ${vw_ageddebt_salecode_desc.sales_code_h} = ${vw_ageddebt_targets.sales_code_h}  ;;
                  ...
                  relationship: one_to_one
                  sql_on: ${vw_ageddebt_salecode_desc.sales_code_h} = ${vw_ageddebt_current.sales_code_h} and ${vw_ageddebt_salecode_desc.cust_key} = ${vw_ageddebt_current.cust_key} and ${vw_ageddebt_new_30032021.customer_key} = ${vw_ageddebt_current.cust_key} ;;
                  }
